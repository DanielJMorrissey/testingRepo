...
public class PaintView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
     ...
     /*
    Figure out a method to get the endpoints a guide to how is in stackoverflow
    1. try using just start and endpoints
    2. try using all points on path (reasonable amount)
     */
                ...
                for (FingerPath fp : paths) {
                    ...
                    for (FloatPoint testingPoint : testing) {
                        if (sectionTestX == 0.0f && sectionTestY == 0.0f) {
                            ...
                            fp.path.quadTo(sectionTestX, sectionTestY, testingPoint.getX(), testingPoint.getY());
